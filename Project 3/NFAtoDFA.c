...
{ 
	...
	strcpy(&NFA_TABLE[0][2], "AB"); 
	strcpy(&NFA_TABLE[1][0], "-"); 
	strcpy(&NFA_TABLE[1][1], "-"); 
	strcpy(&NFA_TABLE[1][2], "BCF"); 
	strcpy(&NFA_TABLE[2][0], "D"); 
	strcpy(&NFA_TABLE[2][1], "C"); 
	strcpy(&NFA_TABLE[2][2], "C");
	strcpy(&NFA_TABLE[3][0], "E"); 
	strcpy(&NFA_TABLE[3][1], "D"); 
	strcpy(&NFA_TABLE[3][2], "D"); 
	strcpy(&NFA_TABLE[4][0], "-"); 
	strcpy(&NFA_TABLE[4][1], "E"); 
	strcpy(&NFA_TABLE[4][2], "EF"); 
	strcpy(&NFA_TABLE[5][0], "-"); 
	strcpy(&NFA_TABLE[5][1], "-"); 
	strcpy(&NFA_TABLE[5][2], "FGB"); 
	strcpy(&NFA_TABLE[6][0], "-"); 
	strcpy(&NFA_TABLE[6][1], "G"); 
	strcpy(&NFA_TABLE[6][2], "G"); 
